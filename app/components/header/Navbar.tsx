...
export const navLinks = [
  ...
  { name: "Getstart", id: "getstart" },
  { name: "Pricing", path: "/pricing/" },
  { name: "Contact us", id: "getready" },
];
      ...
      (entries) => {
        ...
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            // 1️⃣ Update active state
            setActiveSection(id);

            // 2️⃣ Update URL hash WITHOUT navigation
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 border-b transition-all ${
        isScrolled
          ? "bg-transparent backdrop-blur-md border-white shadow-lg py-0"
      ...
      <div className="mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 py-2 flex items-center justify-between">
        ...
        <div className="lg:hidden gap-3">
          <div
            ...
            className="flex p-1 lg:hidden bg-(--color-secondary) rounded-full border-white border justify-center items-center"
          >
          ...
          <AnimatePresence>
            {isNavOpen && (
              ...
              >
                ...
                >
                  {/* Close button */}
                  <div className="flex absolute top-7.25 right-4 md:right-8 lg:hidden z-20 ">
                    <Crossicon onClick={() => setIsNavOpen(false)} />
                  </div>
