...
import { FaUser, FaChartBar, FaUsers, FaHome } from "react-icons/fa";
...
<div className="mb-8 flex justify-center ">
  ...
  />
      ...
      <nav className="space-y-3">
        ...
        {/* Employees */}
        <div className="flex items-center gap-3 bg-[#8D6BDC] text-white px-4 py-2 rounded-xl cursor-pointer">
