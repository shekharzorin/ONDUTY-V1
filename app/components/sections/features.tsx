...
import features from "@/public/images/iMockup - iPhone 14 (1).png";
        ...
        >
          ...
          <Button
            ...
            className="
              ...
              bg-linear-to-r from-[#fff4da] to-[#ffe6d0]
              hover:animate-pulse text-black/70
              md:text-lg lg:mt2 xl:mt-4 shadow-lg flex md:w-[80%] lg:w-[50%] md:mx-auto lg:mx-0"
          />
