...
const workflowItems = [
  ...
  },
  {
    ...
    image: "/images/Employee Tracking.png",
    layout: "end",
  },
  {
    id: 3,
    ...
    image: "/images/Detailed Reporting & analytics.png",
    layout: "start",
  },
  {
    id: 4,
...
const Workflow = () => {
  return (
    <section
      id="workflow"
      className="relative overflow-hidden mt-20 px-4 w-full sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384"
    >
      {/* Background flare */}
      ...
      <div className="flex flex-col w-full mt-20 ">
        ...
        <div className="flex flex-col py-10">
          {workflowItems.map((feature, index) => (
            <div
              key={index}
              className={`flex flex-col lg:flex-row items-center gap-5 py-10 lg:gap-24 ${
            ...
            >
              ...
              <motion.div
                ...
                viewport={{ once: false }}
                transition={{ type: "spring", stiffness: 100, damping: 20 }}
                className="flex flex-col text-center lg:text-start gap-3 lg:gap-6"
              >
