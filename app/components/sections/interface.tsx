...
import dashboard from "@/public/images/dash-board.png";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full py-20">
        ...
        >
          <div className=" animate-pulse flex gap-20 flex-col w-full items-center">
        ...
        {/* Interface Cards */}
        <div className="flex flex-col mt-20 gap-20 lg:flex-row items-center">
          {cards.map((card) => (
            <motion.div
              key={card.id}
              initial={card.initial}
              whileInView={card.animate}
              viewport={{ once: false, ...(card.viewport || {}) }}
            ...
            >
              ...
              />
              <p className="text-lg md:text-xl font-semibold mt-5 text-center">{card.title}</p>
            </motion.div>
          ))}
        </div>
      </div>
