...
const Footer = () => {
  return (
    <section
      id="footer"
      className="relative px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 w-full mt-10"
    >
      {/* Background flare */}
      ...
      <div className="flex flex-col py-5 lg:py-10 lg:flex-row lg:justify-between gap-5 lg:gap-20 border border-white rounded-3xl shadow-2xl">
