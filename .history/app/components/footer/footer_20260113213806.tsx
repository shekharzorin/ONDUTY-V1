...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className="md:text-lg flex flex-col pt-3 lg:pt-10 lg:flex-row lg:justify-between gap-10 lg:gap-20">
        ...
        <div className="flex flex-wrap text-(--color-gray) justify-between w-full gap-10 lg:px-0 text-center px-5">
          {footerLinks.map((section) => (
            <div key={section.title} className="flex flex-col gap-50">
