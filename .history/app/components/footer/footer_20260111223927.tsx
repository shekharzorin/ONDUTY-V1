...
const Footer = () => {
  return (
    <section
      id="footer"
      className="relative px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 w-full mt-10 border-t border-white shadow-2xl "
    >
      {/* Background flare */}
      ...
      <div className="flex flex-col py-5 lg:py-10 lg:flex-row lg:justify-between">
        <div className="flex flex-col gap-5 w-full lg:w-[30%] mt-10">
