  ...
  return (
    ...
    >
      ...
      <div className="md:text-lg flex flex-col py-5 lg:py-10 lg:flex-row lg:justify-between gap-10 lg:gap-20">
        ...
        <div className="flex flex-wrap text-(--color-gray) justify-between w-full gap-10 lg:px-0 text-center">
          {footerLinks.map((section) => (
            <div key={section.title} className="flex flex-col gap-5 border p-10">
