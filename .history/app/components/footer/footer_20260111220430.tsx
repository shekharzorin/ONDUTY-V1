...
const Footer = () => {
  return (
    <section
      id="footer"
      className="relative px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 w-full mt-10 border-t border-black shadow-2xl bg-linear-to-r from-[#eccfff]/50 to-[#fff4da]/50 h-screen"
    >
      {/* Background flare */}
