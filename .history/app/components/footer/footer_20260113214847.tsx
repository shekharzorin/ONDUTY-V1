...
import { FaFacebook, FaInstagram, FaInstagramSquare, FaYoutube } from "react-icons/fa";
...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col pt-3 lg:pt-10 lg:flex-row lg:justify-between gap-5 lg:gap-20">
        ...
        <div className="flex flex-wrap text-(--color-gray) justify-between w-full gap-5 lg:px-0 text-center px-5">
      ...
      <div className="text-(--color-gray) flex flex-col md:flex-row md:justify-between gap-5 my-5">
