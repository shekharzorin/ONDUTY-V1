  ...
  return (
    ...
    >
      ...
      <div className="md:text-lg flex flex-col py-5 lg:py-10 lg:flex-row lg:justify-between gap-10 lg:gap-20">
        ...
        <div className="flex text-(--color-gray) justify-between w-full px-5 lg:px-0 text-center">
          {footerLinks.map((section) => (
            <div key={section.title} className="flex flex-col gap-5">
              ...
              {section.links.map((link) => (
                ...
                >
                  <p className="flex grid-cols-2 grid-rows-2 items-center gap-2 justify-center">
                    {link.icon}
                    {link.label}
                  </p>
                </Link>
