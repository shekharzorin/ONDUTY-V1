...
const Contact = () => {
  return (
    <div className="flex flex-col w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto bg-linear-to-r from-[#eccfff]/50 to-[#fff0cd]/50">
      <div className="flex flex-col gap-10 mb-15 items-center justify-center mt-30">
        <motion.div
          initial={{ opacity: 0, scale: 0.8 }}
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: false }}
          transition={{ type: "spring", stiffness: 100, damping: 20 }}
          className="w-full max-w-md rounded-3xl p-7 border border-white/50 bg-linear-to-r from-[#eccfff]/50 to-[#fff4da]/50 shadow-2xl flex flex-col gap-10"
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-5 items-center">
              ...
              <div>
                ...
                <p className="font-semibold">Siddipet IT Tower, 2nd floor</p>
              </div>
            </div>
          </div>
        </motion.div>
