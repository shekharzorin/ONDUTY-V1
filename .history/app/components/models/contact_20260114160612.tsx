    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      ...
      >
        ...
        <div className="flex flex-col gap-10 px-3">
          <MdCall size={40} className="p-2 rounded-full bg-[#fff0cd] text-(--color-gray) hover:scale-110 transition-all duration-300" />
          <TbMailFilled size={40} className="p-2 rounded-full bg-[#fff0cd] text-(--color-gray) hover:scale-110 transition-all duration-300" />
        </div>
