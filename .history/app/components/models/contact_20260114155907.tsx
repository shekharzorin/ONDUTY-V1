  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      ...
      >
        ...
        <div className="flex flex-col gap-5 items-center justify-between text-center px-5">
          <div className="flex flex-col items-center gap-2">
            <MdCall size={40} className="p-2 rounded-full bg-amber-100" />
            <p>Contact Info</p>
          </div>
          <div className="flex flex-col items-center gap-2">
            <TbMailFilled size={40} className="p-2 rounded-full bg-amber-100" />
            <p>Mail to OnDuty</p>
          </div>
        </div>
