    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      ...
      >
        ...
        <div className="flex flex-col gap-5 px-3">
          <MdCall size={40} className="p-2 rounded-full bg-[#fff0cd] text-(--color-gray) hover:scale-105 transition-all duration-300" />
          <TbMailFilled size={40} className="p-2 rounded-full bg-[#fff0cd] text-(--color-gray) hover:scale-105" />
        </div>
