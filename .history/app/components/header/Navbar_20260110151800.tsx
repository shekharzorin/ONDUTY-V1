...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div
        className="mx-auto w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 py-2 flex items-center justify-between  max-w-[1536px] 
        2xl:max-w-[1320px] 3xl:max-w-[1200px] "
      >
