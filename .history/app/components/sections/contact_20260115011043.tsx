...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col gap-10 mb-15 items-center justify-center">
      ...
      <div
        onClick={handleFlip}
        className="flip-card w-full max-w-md rounded-3xl p-7 border border-white shadow-lg flex flex-col gap-10"
      >
        <motion.div
        ...
        >
          <div className="flip-card-front w-full h-[100%] text-white p-6 rounded-2xl">
            <p>Hello</p>
            <p>How are you</p>
          </div>

          <div className="flip-card-back flex flex-col gap-5 bg-amber-200">
