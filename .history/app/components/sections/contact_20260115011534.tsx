...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col gap-10 mb-15 items-center justify-center">
      ...
      <div
        onClick={handleFlip}
        className="flip-card relative w-full max-w-md h-[360px] rounded-3xl border border-white bg-white/30 shadow-lg cursor-pointer"
      >
        <motion.div
        ...
        >
          ...
          <div className="flip-card-back absolute inset-0 bg-amber-600 p-6 rounded-2xl flex flex-col gap-5">
