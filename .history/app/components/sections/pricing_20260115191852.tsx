            ...
            {Object.entries(plans).map(([planName, features]) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex flex-col backdrop-blur-md border border-white bg-white/30 shadow-lg rounded-3xl w-full md:w-fit gap-3 p-5 hover:shadow-[#8d8d8d] hover:scale-110 transition duration-300"
                >
                  {/* Plan name */}
                    ...
                    {planName !== "trial" ? (
                      <>
                        <Button
                          ...
                          className="border border-white p-4 w-full rounded-full bg-[#fff0cd]/50 hover:bg-[#eccfff] text-black/70"
                        />
                        <Button
                          title={
