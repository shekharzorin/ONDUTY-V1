...
const Getready = () => {
  return (
    ...
    >
      ...
      <div className=" px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384    flex flex-col bg-[#eccfff]/30 backdrop-blur-md shadow-2xl border border-white rounded-4xl w-full px-5 md:px-40 xl:px-60 py-20">
        <motion.div
