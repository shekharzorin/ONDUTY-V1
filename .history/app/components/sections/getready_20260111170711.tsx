  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-[#eccfff] rounded-full blur-3xl opacity-70" />
        <div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] bg-[#fff4da] rounded-full blur-3xl opacity-70" />
      </div>
