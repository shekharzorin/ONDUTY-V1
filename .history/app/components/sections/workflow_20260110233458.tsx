          ...
          {workflowItems.map((feature, index) => (
            ...
            >
              ...
              <p className="md:text-xl lg:text-lg xl:text-xl lg:mt-2 xl:mt-2 text-(--color-gray) lg:text-balance">
                ...
                Join <span className="font-bold"> 10,000+ </span> companies
                using OnDuty today.
              </p> */}

              <div className="flex-1 space-y-6 text-center leading-[1.15]">
                <h3 className="text-2xl md:text-4xl lg:text-3xl xl:text-5xl font-bold leading-[1.15] lg:text-balance">
                  {feature.title}
                </h3>
