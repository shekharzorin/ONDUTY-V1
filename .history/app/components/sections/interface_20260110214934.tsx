...
const Interface = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full mt-20 pb-20">
        {/* Section Heading */}
        <motion.div
        ...
        {/* Interface Cards */}
        <div className="flex flex-col mt-20 gap-15 lg:flex-row items-center">
          {cards.map((card) => (
            <motion.div
              key={card.id}
            ...
            >
              ...
              />
              <p className="text-xl font-bold mt-5 text-center">{card.title}</p>
            </motion.div>
          ))}
        </div>
      </div>
