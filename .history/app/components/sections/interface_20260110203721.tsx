  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full mt-15">
        ...
        <div className="flex flex-col mt-20 gap-5 lg:flex-row items-center">
          <motion.div
          ...
          >
            <Image
              ...
              width={300}
              height={300}
              className="md:w-xl lg:flex lg:w-3xl shadow-2xl rounded-3xl relative transform transition-transform duration-700 hover:scale-105"
            />
          </motion.div>
          ...
          >
            <Image
              ...
              width={300}
              height={300}
              className="lg:flex lg:w-3xl shadow-2xl rounded-3xl relative transform transition-transform duration-700 hover:scale-105"
            />
          </motion.div>
