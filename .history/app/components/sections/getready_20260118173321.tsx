...
const Getready = () => {
  ...
  return (
    <section
      id="getready"
      className="relative px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 w-full flex items-center justify-center"
    >
      {/* Background flare */}
      ...
      <motion.div
        ...
        className="flex flex-col backdrop-blur-sm shadow-lg border border-white rounded-4xl w-[90%] px-5 md:px-40 xl:px-60 py-10 md:py-20 my-15"
      >
          ...
          <div className="w-full">
            <Button
              ...
              className="
                ...
                p-3 md:p-4 rounded-full w-full
                border border-white
                bg-linear-to-r from-[#fff4da] to-[rgb(255,230,208)]
                hover:animate-pulse
                backdrop-blur-md
                shadow-lg
              "
