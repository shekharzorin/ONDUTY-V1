  ...
  return (
    ...
    >
      <div className="flex gap-20 flex-col w-full mt-20">
        <div className="flex px-4 py-2 bg-[#ffeadd] text-[#ff7b00] shadow-lg border border-[#f4e7ff] rounded-full items-center justify-center w-fit gap-3 opacity-50 animate-pulse">
