      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between h-fit gap-5 md:gap-10 mt-40">
        ...
        >
          ...
          <Button
            ...
            className="border border-white p-3 w-full rounded-full bg-[#fff0cd] text-black hover:bg-[#eccfff] md:text-lg lg:mt2 xl:mt-4 shadow-lg flex md:w-[80%] lg:w-[50%] md:mx-auto lg:mx-0"
      ...
      {isOpenCreateAccount && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          ...
          <motion.div
            ...
            className="relative w-[90%] max-w-md bg-transparent rounded-3xl shadow-2xl p-5 border border-white/50 bg-linear-to-r from-[#eccfff]/60 to-[#fff4da]/60"
          >
            {/* Close Button */}
            <div
              onClick={() => setIsOpenCreateAccount(false)}
              className="absolute top-4 right-4 z-30 h-9 w-9 flex items-center justify-center rounded-full bg-white/70 hover:bg-white shadow-md transition"
            >
              <Crossicon onClick={() => setIsOpenCreateAccount(false)} />
            </div>

            <div className="flex flex-col">
              <p className="text-xl md:text-2xl lg:text-2xl font-bold">Create Account</p>
            </div>

            <div className="flex flex-col gap-15 mb-15">
              <div className="flex flex-col mt-30 gap-3">
                <p className="text-xl md:text-2xl lg:text-2xl font-bold leading-[1.15] lg:text-balance">
                  Create Account
                </p>
                <p className="md:text-xl lg:text-lg xl:text-xl lg:mt-2 xl:mt-2 text-(--color-gray) lg:text-balance">
            ...
            <Button
              title="Close"
              onClick={() => setIsOpenCreateAccount(false)}
              className="border shadow-2xl border-white p-3 w-full rounded-full bg-[#fff0cd]/50 text-black hover:bg-[#eccfff]"
            />
          </motion.div>
        </div>
      )}
