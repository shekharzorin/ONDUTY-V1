  ...
  return (
    <section className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto w-full">
      ...
      <div className="flex flex-col gap-5 mt-30 mb-15 md:text-lg text-(--color-gray)">
        ...
        <p>
          <span className="text-xl lg:text-2xl font-semibold text-black">1. Information We Collect</span><br />
          <span>
            We collect the following categories of information to provide employee management and tracking services. <br />
          </span>
          <span>
