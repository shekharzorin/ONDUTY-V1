            ...
            {Object.entries(plans).map(([planName, features]) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex flex-col backdrop-blur-md border border-white bg-white/30 shadow-lg rounded-3xl w-full md:w-fit gap-3 p-7 hover:shadow-[#8d8d8d] hover:scale-110 transition duration-300"
                >
                  {/* Plan name */}
