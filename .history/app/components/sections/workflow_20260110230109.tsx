            ...
            return (
              ...
              >
                ...
                {(!isStart || isStart) && (
                  ...
                  >
                    <div className="flex-1 w-[80%] relative group">
                      <div className="rounded-[2.5rem] overflow-hidden bg-white shadow-2xl">
                        <div className="inset-0 from-gray-50 to-white opacity-50" />
                        <img
                          src={item.image}
                          alt={item.title}
                          className="relative h-[80%] transform transition-transform duration-700 hover:scale-105"
                        />
                      </div>
                    </div>
                  </motion.div>
