...
const Getready = () => {
  return (
    <section
      id="getready"
      className="relative overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 w-full my-5 md:my-10"
    >
      {/* Background flare */}
      ...
      <div className="flex flex-col bg-[#eccfff]/30 backdrop-blur-md shadow-2xl border border-white rounded-4xl w-full px-5 md:px-40 xl:px-60 py-20">
        <div className="flex flex-col gap-5 items-center text-center justify-center">
          ...
          <p className="md:text-lg text-(--color-gray)">
            Join thousands of companies tracking there employees and daily attendance with OnDuty. <br />
