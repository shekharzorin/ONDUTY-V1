...
const Bookdemo = () => {
  ...
  return (
    <section className="flex flex-col gap-10 pb-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto items-center justify-center bg-linear-to-r from-[#eccfff]/50 to-[#fff0cd]/50 min-h-screen w-full">
      ...
      >
        ...
        >
          <Inputbox
            ...
            className="rounded-xl bg-white font-semibold md:text-lg text-black"
          />
          <Inputbox
          ...
          <div className="flex w-full p-4 bg-white rounded-xl gap-2 text-(--color-gray)">
            <MdEdit size={28} />
            <textarea
