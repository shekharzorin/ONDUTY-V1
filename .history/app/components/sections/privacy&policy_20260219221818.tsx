      ...
      <div className="flex flex-col gap-5 mt-30 mb-15 md:text-lg text-(--color-gray)">
        ...
        <div className="flex flex-col mt-3 gap-3">
          ...
          <ul className="list-disc pl-10">
            ...
            <li>The application does not track location outside working hours.</li>
            <li>Certain features may not function if location services are disabled.</li>
          </ul>
        ...
        <div className="flex flex-col mt-3 gap-3">
          ...
          <span>
           We implement appropriate technical and organizational security measures to protect your data, including : <br />
          </span>
