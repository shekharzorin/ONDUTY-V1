      ...
      >
        ...
        >
          <Inputbox
            ...
            className="rounded-xl bg-gray-200 font-semibold md:text-lg text-black"
          />
          <Inputbox
            ...
            className="rounded-xl bg-red-300 font-semibold md:text-lg text-black"
          />

          <div className="flex w-full p-4 bg-red-300 rounded-xl gap-2 text-(--color-gray)">
            <MdEdit size={28} />
            <textarea
