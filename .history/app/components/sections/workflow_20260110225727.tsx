                ...
                {(!isStart || isStart) && (
                  ...
                  >
                    <div className="flex-1 w-full relative group">
                      <div className="relative h-[320px] md:h-[380px] lg:h-[420px] rounded-[2.5rem] shadow-2xl overflow-hidden bg-white">
                        {/* background overlay */}
                        ...
                        <img
                          src={item.image}
                          alt={item.title}
                          className="absolute inset-0 z-10 w-full h-full object-contain transform transition-transform duration-700 hover:scale-105"
                        />
                      </div>
                    </div>
                  </motion.div>
