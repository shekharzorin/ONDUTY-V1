...
const workflow = () => {
  return (
    <section
      id="workflow"
      className="relative overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 mt-20"
    >
      {/* Background flare */}
      ...
      <div className="flex gap-20 flex-col w-full">
        ...
        <div className="flex flex-col gap-20 w-full">
          ...
          <div className="flex flex-col items-center justify-center lg:justify-between lg:flex-row gap-5 lg:gap-20">
            <motion.div
              className=" flex items-center justify-center"
              initial={{ opacity: 0, x: -100 }}
              whileInView={{ opacity: 1, x: 0 }}
