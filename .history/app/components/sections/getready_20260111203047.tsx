...
const Getready = () => {
  return (
    ...
    >
      <div className="flex flex-col bg-linear-to-r from-[#fff4da]/40 to-[#eccfff]/40 backdrop-blur-3xl shadow-lg border border-white rounded-4xl w-full px-5 md:px-40 xl:px-60 py-10 md:py-20 my-5 md:my-10">
