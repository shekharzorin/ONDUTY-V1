...
const Getready = () => {
  return (
    ...
    >
      ...
      {/* Background flares */}
      <div className="absolute top-0 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none -z-10">
      ...
      <div className="flex flex-col bg-[#eccfff]/40 backdrop-blur-md shadow-2xl border border-white rounded-4xl w-full px-0 md:px-40 xl:px-60 py-20">
        <motion.div
