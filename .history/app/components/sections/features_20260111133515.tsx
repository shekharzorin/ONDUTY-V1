...
import BackgroundFlare from "../ui/BackgroundFlare";

const Features = () => {
  return (
    <section
      id="features"
      className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384"
    >
      {/* Background flare */}
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between h-fit gap-5 mt-40">
        <motion.div
