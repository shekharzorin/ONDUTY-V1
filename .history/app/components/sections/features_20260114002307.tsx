      ...
      {isOpenCreateAccount && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          ...
          <motion.div
            ...
            className="relative w-[90%] max-w-md bg-transparent rounded-3xl shadow-2xl p-5 border border-white/50 bg-linear-to-r from-[#eccfff] to-[#fff4da] flex flex-col gap-10"
          >
            {/* Close Button */}
            <div
