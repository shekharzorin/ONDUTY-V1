      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between h-fit gap-5 md:gap-10 mt-40">
        ...
        >
          ...
          <Button
            ...
            className="border border-white p-3 w-full rounded-full bg-[#fff0cd]/50 text-black hover:bg-[#eccfff] md:text-lg lg:mt2 xl:mt-4 shadow-lg flex md:w-[80%] lg:w-[50%] md:mx-auto lg:mx-0"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          ...
          >
            ...
            <Button
              title="Close"
              onClick={() => setIsOpenCreateAccount(false)}
              className="border border-white p-3 w-full rounded-full bg-[#fff0cd]/50 text-black hover:bg-[#eccfff]"
            />
          </motion.div>
        </div>
      )}
