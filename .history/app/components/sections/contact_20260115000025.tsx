      ...
      <div className="flex flex-col gap-10 mb-15 items-center justify-center">
        ...
        <div className="relative w-full max-w-md perspective-1000">
          ...
          >
            ...
            <div className="absolute inset-0 backface-hidden rounded-3xl p-7 border border-white bg-white/30 shadow-lg flex flex-col gap-10">
              <div className="flex flex-col gap-10 md:text-lg">
                <div className="flex flex-col gap-5">
                  <p className="font-bold text-xl">Contact Information</p>
            ...
            <div className="absolute inset-0 backface-hidden rotate-y-180 rounded-3xl bg-gradient-to-br from-[#6b4eff] to-[#b79cff] text-white shadow-xl flex flex-col items-center justify-center p-10">
