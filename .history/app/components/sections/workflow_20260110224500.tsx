                ...
                {(!isStart || isStart) && (
                  ...
                  >
                    ...
                    <div className="flex-1 w-full relative group">
                      <div className="relative rounded-[2.5rem] shadow-2xl overflow-hidden bg-white">
                        <div className="absolute inset-0 from-gray-50 to-white opacity-50" />
                        <img
                          src={item.image}
                          alt={item.title}
                    ...
                    <div className="flex-1 w-full relative group">
                      <div className="relative rounded-[2.5rem] overflow-hidden bg-white">
                        ...
                        <img
                          src={item.image}
                          alt={item.title}
                          className="relative shadow-2xl w-full h-auto transform transition-transform duration-700 hover:scale-105"
                        />
                      </div>
                    </div>
                  </motion.div>
