...
import BackgroundCurvedLines from "../ui/BackgroundCurvedLines";
...
const Getready = () => {
  return (
    <section
      id="getready"
      className="relative px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 w-full bg-linear-to-r from-[#eccfff]/30 to-[#fff0cd]/30"
    >
      <BackgroundCurvedLines />
      <div className="flex flex-col bg-transparent bg-linear-to-r backdrop-blur-sm shadow-lg border border-white/80 rounded-4xl w-full px-5 md:px-40 xl:px-60 py-10 md:py-20 my-5 md:my-10">
