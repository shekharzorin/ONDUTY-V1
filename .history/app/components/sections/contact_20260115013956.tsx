...
const Contact = () => {
  ...
  return (
    <section className="flex flex-col gap-10 pb-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto items-center justify-center bg-linear-to-r from-[#eccfff]/50 to-[#fff0cd]/50">
      ...
      <div
        onClick={handleFlip}
        className="flip-card relative w-[100%] max-w-md h-100 rounded-3xl cursor-pointer"
      >
        <motion.div
        ...
        >
          ...
          <div className="flip-card-back absolute inset-0 backdrop-blur-md border border-white bg-white/30 shadow-lg rounded-3xl p-6 flex flex-col gap-5">
