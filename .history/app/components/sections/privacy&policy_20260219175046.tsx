    ...
    <section className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto w-full">
      ...
      <div className="flex flex-col gap-5 mt-30 mb-15 md:text-lg text-(--color-gray)">
        ...
        <p className="flex flex-col mt-3 gap-3">
          ...
          <span className="font-semibold text-black">b) GPS Location Information</span>
          <ul className="list-disc pl-10">
          ...
          <span className="font-semibold text-black">c) Device Information</span>
          <ul className="list-disc pl-10">
            <li>IP address</li>
            <li>Network type</li>
          </ul>

          <span className="font-semibold text-black">d) Work-related Information</span>
          <ul className="list-disc pl-10">
