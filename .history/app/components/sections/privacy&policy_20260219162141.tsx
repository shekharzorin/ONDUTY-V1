  ...
  return (
    <section className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto w-full">
      ...
      <div className="flex flex-col items-center justify-center gap-10 mt-30 mb-15">
        <p className="text-2xl lg:text-3xl font-bold leading-[1.5] lg:text-balance text-center justify-center items-center">
          PRIVACY POLICY <br /> <span className="text-xl lg:text-2xl font-semibold ">OnDuty Employee Tracking System</span> 
        </p>
      </div>
    </section>
  );
