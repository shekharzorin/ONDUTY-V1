...
const PrivacyPolicy = () => {
  return (
    <section className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto w-full">
      ...
      <div>
        <p className="text-2xl lg:text-3xl font-bold leading-[1.15] lg:text-balance tetx-center justify-center items-center">
          PRIVACY POLICY — OnDuty Employee Tracking System
        </p>
      </div>
    </section>
  );
