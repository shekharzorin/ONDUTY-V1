            ...
            {Object.entries(plans).map(([planName, features]) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex flex-col backdrop-blur-md border border-white bg-white/30 shadow-lg rounded-3xl w-full md:w-fit gap-3 p-10 hover:shadow-[#8d8d8d] hover:scale-105 hover:rotate-1 transition duration-300"
                >
                  {/* Plan name */}
                  ...
                  <div className="flex flex-col">
                    {planName === "trial" ? (
                      <>
                        ...
                        <p className="text-gray-500">₹0 upto 7 days</p>
                      </>
                    ) : (
                      <>
                    ...
                    {planName !== "trial" ? (
                      <>
                        <Button
                          ...
                          className="border border-white p-4 w-full rounded-full bg-[#fff0cd]/50 hover:bg-[#eccfff] text-black"
                        />
                        <Button
                          title={
                      ...
                      <Button
                        ...
                        disabled={buttonLoading !== null}
                        className="border border-white p-4 w-full rounded-full bg-[#fff0cd]/50 hover:bg-[#eccfff] text-(--color-gray)"
                      />
                    )}
                  </div>
                </motion.div>
