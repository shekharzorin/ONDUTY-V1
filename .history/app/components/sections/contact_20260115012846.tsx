...
const Contact = () => {
  ...
  return (
    <section className="flex flex-col gap-10 mb-15 items-center justify-center bg-linear-to-r from-[#eccfff]/50 to-[#fff0cd]/50 h-screen">
      <div className="flex flex-col items-center justify-center mt-10 text-center gap-5">
