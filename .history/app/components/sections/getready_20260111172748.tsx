...
const Getready = () => {
  return (
    ...
    >
      ...
      <div className=" mx-4 sm:px-6 md:mx-8 lg:px-12 xl:mx-16 2xl:mx-24  flex flex-col bg-[#eccfff]/30 backdrop-blur-md shadow-2xl border border-white rounded-4xl w-full px-5 md:px-40 xl:px-60 py-20">
        <motion.div
