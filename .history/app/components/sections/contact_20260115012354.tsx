...
const Contact = () => {
  ...
  return (
    <section className="flex flex-col gap-10 mb-15 items-center justify-center">
      ...
      >
        ...
        >
          ...
          <div className="flip-card-back absolute inset-0 bg-white/30 border border-white p-6 rounded-2xl flex flex-col gap-10">
