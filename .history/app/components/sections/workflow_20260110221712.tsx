                ...
                {(!isStart || isStart) && (
                  ...
                  >
                    <Image
                      ...
                      width={400}
                      height={400}
                      className={`shadow-2xl rounded-3xl transform transition-transform duration-700 hover:scale-105`}
                    />
                  </motion.div>
                )}
                ...
                {!isStart && (
                  ...
                  >
                    <Image
                      src={item.image}
                      alt={item.title}
                      className="lg:w-fit shadow-2xl rounded-3xl transform transition-transform duration-700 hover:scale-105"
                    />
                  </motion.div>
                )}
              </div>
