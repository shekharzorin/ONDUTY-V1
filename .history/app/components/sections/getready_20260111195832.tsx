...
const Getready = () => {
  return (
    ...
    >
      <div className="flex flex-col bg-linear-to-r from-[#eccfff] to-[#fff4da] backdrop-blur-md shadow-2xl border border-white rounded-4xl w-full px-5 md:px-40 xl:px-60 py-20 my-0">
