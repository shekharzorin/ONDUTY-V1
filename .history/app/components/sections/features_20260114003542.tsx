      ...
      {isOpenCreateAccount && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          ...
          <motion.div
            ...
            className="relative w-[90%] max-w-md bg-transparent rounded-3xl shadow-2xl p-5 border border-white/50 bg-linear-to-r from-[#eccfff]/50 to-[#fff4da]/50 flex flex-col gap-10"
          >
            {/* Close Button */}
            <div
            ...
            >
              <Inputbox
                ...
                className="rounded-xl bg-white/20 font-semibold text-lg"
              />
              <Inputbox
