    ...
    >
      <div className="flex flex-col bg-(--color-secondary) rounded-4xl w-full px-5 md:px-40 xl:px-60 py-20 lg:py-30">
        ...
        <div className="flex flex-col lg:flex-row gap-5 mt-20">
            <Button title="Hello" className="p-3 lg:p-4 rounded-full lg:w-[50%] bg-white/30 backdrop-blur-md"/>
            <Button title="Chello" className="p-3 lg:p-4 rounded-full lg:w-[50%] bg-white/30 "/>
        </div>
      </div>
    </section>
  );
