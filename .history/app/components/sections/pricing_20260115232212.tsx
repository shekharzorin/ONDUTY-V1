                    ...
                    {planName !== "trial" ? (
                      <>
                        <Button
                          ...
                          className="border border-white p-3 w-full rounded-full bg-[#fff0cd]/50 hover:bg-[#eccfff] text-black/70"
                        />
                        <Button
                          title={
                          ...
                          className="
                            ...
                            bg-[#fff0cd]/50 hover:bg-[#eccfff] text-black/70"
                        />
                      </>
                    ) : (
                      <Button
                        ...
                        className="
                          ...
                          hover:animate-pulse hover:bg-[#eccfff]
                          text-black/70"
                      />
                    )}
                  </div>
