...
const Getready = () => {
  return (
    ...
    >
      <div className="flex flex-col bg-(--color-secondary)/50 rounded-4xl w-full px-5 md:px-40 xl:px-60 py-20 lg:py-30">
        <motion.div
        ...
        <div className="flex flex-col lg:flex-row gap-5 mt-20">
          <div className="flex hover:animate-ping w-full">
            <Button
              title="Hello"
              className="
                p-3 lg:p-4 rounded-full lg:w-[50%]
                bg-linear-to-r from-[#ffcfea] to-[#e9c9ff]
                hover:animate-pulse
                backdrop-blur-md
                shadow-lg
            "
          ...
          <Button
            title="Chello"
            className="
                p-3 lg:p-4 rounded-full lg:w-[50%] text-black
                border border-white
                bg-white/30
                backdrop-blur-md
                shadow-lg
