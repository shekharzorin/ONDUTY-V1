...
const Getready = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col bg-black bg-linear-to-r backdrop-blur-sm shadow-lg border border-white rounded-4xl w-full px-5 md:px-40 xl:px-60 py-10 md:py-20 my-5 md:my-10">
