...
const Getready = () => {
  return (
    ...
    >
      <div className="flex flex-col bg-(--color-secondary)/30 rounded-4xl w-full px-5 md:px-40 xl:px-60 py-20 lg:py-30">
        <motion.div
        ...
        <div className="flex flex-col lg:flex-row gap-5 mt-20">
          <Button
            ...
            className="
                ...
                bg-linear-to-r from-(--color-secondary) to-[#edc8ff]
                backdrop-blur-md
                shadow-lg"
          />
          <Button
            ...
            className="
                p-3 lg:p-4 rounded-full lg:w-[50%]
                bg-linear-to-r from-[#ffcfea] to-[#f1d4ff]
                backdrop-blur-md
                shadow-lg
            "
          />
