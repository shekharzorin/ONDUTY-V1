...
const PrivacyPolicy = () => {
  return (
    <section className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto w-full">
      ...
      <div className="flex flex-col gap-6 mt-30 mb-15 md:text-lg text-(--color-gray)">
        ...
        <p className="font-semibold">
          ...
          <span>
            <span> Company Name :</span> Citrux Information and Technology{" "}
            <br />
            <span>Address :</span> Siddipet IT Tower 2nd Floor, Telangana <br />
            <span>Jurisdiction :</span> India
          </span>
        </p>
        <p>
