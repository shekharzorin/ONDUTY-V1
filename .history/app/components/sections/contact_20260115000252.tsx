      ...
      <div className="flex flex-col gap-10 mb-15 items-center justify-center">
        ...
        <div className="relative w-full max-w-md perspective-1000">
          ...
          >
            ...
            <div className="absolute inset-0 backface-hidden rounded-3xl bg-gradient-to-br from-[#6b4eff] to-[#b79cff] text-white shadow-xl flex flex-col items-center justify-center p-10">
              <p className="text-3xl font-bold">OnDuty</p>
              <p className="mt-2 opacity-80">Workforce Management</p>
            </div>

            {/* FRONT SIDE – Contact Info */}
            <div className="absolute inset-0 backface-hidden rotate-y-180 rounded-3xl p-7 border border-white bg-white/30 shadow-lg flex flex-col gap-10">
              <div className="flex flex-col gap-10 md:text-lg">
                <div className="flex flex-col gap-5">
                  <p className="font-bold text-xl">Contact Information</p>
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex gap-5 items-center px-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">Weekend : Closed</p>
                    </div>
                  </div>
                </div>
              </div>
