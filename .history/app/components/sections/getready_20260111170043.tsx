...
const Getready = () => {
  return (
    ...
    >
      <div className="flex flex-col bg-(--color-secondary)/30 backdrop-blur-md shadow-2xl border border-white rounded-4xl w-full px-5 md:px-40 xl:px-60 py-20">
        <motion.div
        ...
        >
          ...
          <p className="md:text-lg text-(--color-gray)">
            Join thousands of companies tracking there employees and daily attendance
            with OnDuty. Start your 7-day free trial now.
          </p>
        </motion.div>
