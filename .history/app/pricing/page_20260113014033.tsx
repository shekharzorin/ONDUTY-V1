      ...
      <div className="flex flex-col gap-15 mb-15">
        ...
        <div className="flex items-center justify-center gap-10 flex-wrap">
          {Object.entries(plans).map(([planName, features]) => {
            ...
            return (
              <div key={planName} className="flex flex-col backdrop-blur-md border border-white bg-black/10 shadow-lg rounded-3xl w-fit gap-8 p-10 hover:shadow-[#8d8d8d] hover:scale-105 hover:rotate-1 transition-hover duration-300 hover:animate-pulse">
