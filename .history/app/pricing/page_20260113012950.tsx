...
const page = () => {
  ...
  return (
    <div className="flex flex-col bg-(--color-bg) w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto bg-linear-to-r from-[#eccfff]/50 to-[#fff0cd]/50">
      {/* Header */}
      <div className="relative flex flex-col gap-15 mb-15">
        ...
        {/* Cards + Center Background Text */}
        <div className="relative flex justify-center">
          {/* Center watermark */}
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            <span
              className=" text-[140px] sm:text-[180px] lg:text-[240px] xl:text-[280px] font-extrabold text-(--color-gray) 
                opacity-500 blur-sm select-none text-center whitespace-nowrap "
            >
              OnDuty
            </span>
          </div>
          ...
          <div className="relative z-10 flex items-center justify-center gap-10 flex-wrap">
            {Object.entries(plans).map(([planName, features]) => {
              ...
              return (
                <div
                  key={planName}
                  className="flex flex-col backdrop-blur-md bg-transparent border border-white shadow-lg rounded-3xl w-fit gap-8 p-10"
                >
