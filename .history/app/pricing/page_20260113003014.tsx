      ...
      <div className="flex flex-col gap-15">
        ...
        <div className="flex items-center justify-center flex-wrap">
          {Object.entries(plans).map(([planName, features]) => {
            ...
            return (
              <div key={planName} className="flex flex-col bg-amber-300 w-fit">
                <p className="text-center p-5 font-bold">{planName}</p>
                <div className="flex flex-col">
                  {planName === "trial" ? (
                    <p className="text-3xl font-bold text-green-600 py-3">Free</p>
                  ) : (
                    <>
