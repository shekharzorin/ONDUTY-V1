        ...
        <div className="flex flex-wrap justify-center gap-6 w-full">
          {Object.entries(plans).map(([planName, features]) => {
            ...
            return (
              <div
                key={planName}
                className="p-6 rounded-3xl bg-(--color-sidebar) shadow-md hover:shadow-[#8d8d8d] hover:scale-105 hover:rotate-2 transition-hover duration-300 flex flex-col w-fit"
              >
                {/* Plan Name */}
