        ...
        <div className="flex items-center justify-center gap-10 flex-wrap">
          {Object.entries(plans).map(([planName, features]) => {
            ...
            return (
              <div
                key={planName}
                className="flex flex-col backdrop-blur-md border border-white bg-white/30 shadow-lg rounded-3xl w-full md:w-fit gap p-10 hover:shadow-[#8d8d8d] hover:scale-105 hover:rotate-1 transition-hover duration-300"
              >
