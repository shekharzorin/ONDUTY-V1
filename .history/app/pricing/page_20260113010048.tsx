...
const page = () => {
  ...
  return (
    <div className="flex flex-col bg-(--color-bg) w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto bg-linear-to-r from-[#ffc1e4] to-[#e7c2ff]">
      {/* Header */}
      <div className="flex flex-col gap-15 mb-15">
        ...
        <div className="flex items-center justify-center gap-10 flex-wrap">
          {Object.entries(plans).map(([planName, features]) => {
            ...
            return (
              <div key={planName} className="flex flex-col backdrop-blur-2xl bg-transparent border border-white rounded-3xl w-fit gap-8 p-10">
