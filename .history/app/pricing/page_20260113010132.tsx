...
const page = () => {
  ...
  return (
    <div className="flex flex-col bg-(--color-bg) w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto bg-linear-to-r from-[#eccfff] to-[#fff0cd]">
      {/* Header */}
