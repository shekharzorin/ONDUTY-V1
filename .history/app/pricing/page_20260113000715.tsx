...
const page = () => {
  ...
  return (
    <div className="flex flex-col bg-(--color-bg) w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto">
      {/* Header (fixed at top) */}
      ...
      <div className="flex flex-1 justify-center items-center w-full my-15">
        <div className="flex flex-wrap justify-center gap-6 w-full">
          {Object.entries(plans).map(([planName, features]) => {
            ...
            return (
              <div
                key={planName}
                className="p-6 rounded-3xl bg-(--color-sidebar) shadow-md hover:shadow-[#8d8d8d] hover:scale-105 hover:rotate-2 transition-hover duration-300 flex flex-col border-2 border-amber-400"
              >
                {/* Plan Name */}
