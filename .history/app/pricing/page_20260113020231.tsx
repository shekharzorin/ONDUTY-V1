...
const page = () => {
  ...
  return (
    <div className="flex flex-col bg-(--color-bg) w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-384 mx-auto bg-linear-to-r from-[#eccfff]/50 to-[#fff0cd]/50">
      {/* Header */}
        ...
        <div className="flex items-center justify-center gap-10 flex-wrap">
          {Object.entries(plans).map(([planName, features]) => {
            ...
            return (
              <div
                key={planName}
                className="flex flex-col backdrop-blur-md border border-white bg-white/30 shadow-lg rounded-3xl w-fit gap-3 p-10 hover:shadow-[#8d8d8d] hover:scale-105 hover:rotate-1 transition-hover duration-300"
              >
                  ...
                  {planName !== "trial" ? (
                    <>
                      <Button
                        ...
                        className="border border-white p-4 w-full rounded-full bg-[#fff0cd]/50 text-black"
                      />
                      <Button
                        title={
                    ...
                    <Button
                      ...
                      disabled={buttonLoading !== null}
                      className="border border-white p-4 w-full rounded-full bg-[#fff0cd]/50 text-black hover:bg-amber-800"
                    />
                  )}
                </div>
              </div>
