                ...
                <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
                  <TouchableOpacity
                    onPress={() => {
                      ...
                      loadEmployeeMeta(selectedEmployee.email);
                    }}
                  >
                        ...
                        <Image
                          source={
                            selectedEmployee.profilePic
                              ? { uri: selectedEmployee.profilePic }
                              : require("../../assets/images/profile.webp")
                          }
                          style={[styles.avatarheight, styles.empavatar]}
                        />
                    ...
                    {liveLocationsMap[selectedEmployee.email] ? (
                      <View style={styles.gap}>
                        ...
                        <EmployeeMap
                          ...
                          coordinates={{
                            latitude:
                              liveLocationsMap[selectedEmployee.email].latitude,
                            longitude:
                              liveLocationsMap[selectedEmployee.email].longitude,
                          }}
                      ...
                      <View
                        style={[styles.centeralign, styles.marginBottom1]}
                      >
                        <Text
                          style={[
                            styles.locationtxt,
