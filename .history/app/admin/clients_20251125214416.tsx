import {
  adminAddClient, adminDeleteClient, adminGetClients, adminUpdateClient,
  fetchClientImageBase64
    ...
    <SafeAreaProvider style={styles.container}>
      <SafeAreaView style={styles.flex}>
        ...
        <Modal visible={modalVisible} onRequestClose={() => handleCloseModal()}>
          <SafeAreaProvider>
            <SafeAreaView style={[styles.paddinghorizontal, styles.container, styles.flex]}>
