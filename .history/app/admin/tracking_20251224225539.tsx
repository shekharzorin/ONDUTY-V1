  ...
  const fetchEmployeesWithStatus = useCallback(async (): Promise<void> => {
    ...
    try {
      ...
      const todayActivities: EmployeeActivity[] =
        dashData?.activities?.find((g: any) => g._id === formattedToday)
          ?.activities || [];
      ...
      const enriched: Employee[] = await Promise.all(
        empRes.map(async (emp: any) => {
          ...
          /* ======================================================
             ✅ FIX: GET ALL EMPLOYEE ACTIVITIES (TODAY)
          ====================================================== */
          const empActivities = todayActivities
