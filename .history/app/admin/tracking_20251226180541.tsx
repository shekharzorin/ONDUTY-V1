...
function Track() {
  ...
  return (
    <>
            ...
            <View style={styles.row}>
              ...
              <View style={[styles.searchcard, styles.h60, { width: "45%" }]}>
                ...
                >
                  <View style={styles.row}>
                    <Text
                      style={[styles.text, styles.color, { marginTop: 3 }]}
                    >
                      {selectedStatus}
                    </Text>
      ...
      <Modal
        visible={addEmpModal}
        onRequestClose={() => setAddEmpModal(false)}
      >
        <SafeAreaProvider style={styles.container}>
          <SafeAreaView style={styles.flex}>
            <View style={[styles.paddinghorizontal, styles.flex]}>
            ...
            >
              <Btn
                title={addEmpLoading ? "Saving..." : "Add Employee"}
              ...
              <View style={[styles.paddinghorizontal, styles.flex]}>
                ...
                <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
                  ...
                  <View style={styles.margintop}>
                    ...
                    {/* Visits list */}
                    <View style={styles.gap}>
                      <Text style={[styles.status, { left: 15 }]}>
                        Total Visits ({totalVisitCount})
                      </Text>
                        ...
                        <FlatList
                          ...
                          renderItem={({ item }) => (
                            ...
                            >
                              ...
                              <View style={styles.flex}>
                                <Text
                                  style={[styles.status, styles.width65]}
                                >
                                  {item.taskName}
                                </Text>
                                <Text
                                  style={[styles.locationtxt, styles.color]}
                                >
                                  {item.type}
                                </Text>
                                ...
                                <Text
                                  style={[styles.rightalign, styles.color]}
                                >
                                  {item.date}
                                </Text>
                              </View>
