    ...
    <div className="flex flex-col h-screen w-full p-5 gap-5">
      ...
      <div className="flex flex-col w-full bg-(--color-sidebar) text-(--color-gray) rounded-2xl shadow-lg p-5 text-[18px] font-semibold gap-5">
        <div className="flex items-center justify-between">
          ...
          {/* DELETE BUTTON */}
          <div
            className=" absolute right-5 top-5 flex items-center justify-end w-fit bg-gray-300 hover:bg-(--color-secondary) hover:scale-110 p-2 rounded-full cursor-pointer transition-all shadow-lg"
