  ...
  return (
    <div className="flex flex-col h-screen w-full p-5 gap-5">
      ...
      <div className="flex flex-col text-[16px] font-semibold w-full bg-(--color-sidebar) rounded-3xl shadow-lg p-5 gap-4">
        <p className="font-bold mb-2">Add Map Api to Activate Map</p>
        ...
        <div className="flex items-center justify-center w-[70%] lg:w-[30%] mx-auto">
          <Button
      ...
      {/* ===============================
          DISPLAY SETTINGS
      =============================== */}
      <div className=" flex flex-col w-full font-semibold text-[16px] text-(--color-gray) bg-(--color-sidebar) rounded-3xl shadow-lg p-5 gap-2">
        <p className="font-bold text-black mb-2">All Api Keys</p>
        ...
        <div className="flex relative justify-between items-center">
          ...
          <div
            className="flex absolute right-0 top-0 md:top-0 bg-gray-300 text-(--color-gray) hover:bg-(--color-secondary) hover:scale-110 hover:text-(--color-primary) p-2 rounded-full cursor-pointer transition-all shadow-lg"
        ...
        <div className="flex relative justify-between items-center">
          ...
          <div
            className="flex absolute right-0 -top-3 md:top-0 bg-gray-300 text-(--color-gray) hover:bg-(--color-secondary) hover:scale-110 hover:text-(--color-primary) p-2 rounded-full cursor-pointer transition-all shadow-lg"
