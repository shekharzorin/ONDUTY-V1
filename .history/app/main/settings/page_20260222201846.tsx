  ...
  return (
    <div className="flex flex-col h-screen w-full p-5 gap-5">
      ...
      {/* ===============================
          DISPLAY SETTINGS
      =============================== */}
      <div className="relative flex flex-col w-full bg-(--color-sidebar) rounded-3xl shadow-lg p-5 gap-4">

        {/* ANDROID */}
        <div className="flex justify-between items-center">
          <div>
            <p className="font-semibold">Android Key:</p>
            <p className="text-sm break-all">{androidKey || "Not set"}</p>
          </div>

          <button onClick={() => handleDelete("android_map_key")}>
            <MdDelete size={24} />
          </button>
        </div>
        ...
        <div className="flex justify-between items-center">
          <div>
            <p className="font-semibold">iOS Key:</p>
            <p className="text-sm break-all">{iosKey || "Not set"}</p>
          </div>
        ...
        <div className="flex justify-between items-center">
          <div>
            <p className="font-semibold">Web Key:</p>
            <p className="text-sm break-all">{webKey || "Not set"}</p>
          </div>
