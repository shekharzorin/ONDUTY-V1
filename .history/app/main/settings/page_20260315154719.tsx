    ...
    <div className="flex flex-col h-screen w-full p-5 gap-5">
      ...
      <div className=" flex flex-col w-full font-semibold text-[16px] text-(--color-gray) bg-(--color-sidebar) rounded-3xl shadow-lg p-5 gap-2">
        ...
        <div className="flex flex-col justify-between items-center">
          ...
          <div
            className="flex justify-end bg-gray-300 text-(--color-gray) hover:bg-(--color-secondary) hover:scale-110 hover:text-(--color-primary) p-2 rounded-full cursor-pointer transition-all shadow-lg"
