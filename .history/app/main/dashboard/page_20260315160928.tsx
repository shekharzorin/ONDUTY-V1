    ...
    <div className="flex flex-col h-screen w-full p-5 gap-5">
      ...
      <div className="flex gap-5 w-full h-12">
        ...
        <div className="w-[45%] md:w-[30%] lg:w-[20%] xl:w-[15%]">
          <button
            className="w-full overflow-hidden text-ellipsis truncate whitespace-nowrap bg-(--color-sidebar) text-(--color-gray) font-medium p-2.5 rounded-2xl shadow-lg flex justify-between items-center"
