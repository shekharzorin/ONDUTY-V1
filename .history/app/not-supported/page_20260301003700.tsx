...
const Page = () => {
  ...
  return (
    <div className="flex flex-col gap-10 items-center justify-center p-5 text-center h-screen font-semibold">
      ...
      {platform !== "other" && (
        ...
        >
          Download for {platform === "android" ? " Android / Tablet" : " iOS / iPad"}
        </a>
      )}
    </div>
  );
