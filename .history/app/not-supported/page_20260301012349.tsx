...
const Page = () => {
  ...
  return (
    <div className="flex flex-col gap-5 items-center justify-center p-10 text-center h-screen font-semibold">
      <div className="relative animate-bounce mb-5 flex">
        <div className="text-3xl font-bold text-(--color-primary) -rotate-6 ">
          Oops !
        </div>
        <Image src={arrowbend} width={50} alt="Arrow Bend" className="absolute mt-5 rotate-6" />
      </div>
