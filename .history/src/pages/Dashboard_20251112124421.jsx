  ...
  const [companies, setCompanies] = useState([
    {
      ...
      contact: "8520852085",
      location: "abc-mncnfch-808-mcnjc",
    ...
    },
    {
      ...
      contact: "8520852085",
      location: "bbh-552053n-jefcfhefgeg-ncefhf451-55",
    ...
    },
    {
      ...
      contact: "8520852085",
      location: "bcghgf-ndfhfkh5229-bkjcff-hchc5-522 bgbgfvc egfdczx erfvc    ersdfcx",
      ...
      {showAddForm && (
        <div className="modal-overlay" onMouseDown={overlayClickClose}>
          <div className="edit-modal" onMouseDown={(e) => e.stopPropagation()}>
            <h2>Add company</h2>
            <button className="close-add-model" onClick={() => setShowAddForm(false)}>
              ×
            </button>
