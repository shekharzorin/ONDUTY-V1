...
import Onduty_logo from "./Images/Onduty_logo.png";

const CompaniesPage = () => {
  const [companies, setCompanies] = useState([
    {
      id: 1,
      name: "Citrix pharma limited",
      email: "vennelaaveni5499@gmail.com",
      contact: "",
      location: "",
    ...
    },
    {
      id: 3,
      name: "HCL",
      email: "vennelaaveni5799@gmail.com",
      contact: "",
      location: "",
  ...
  //   // ✅ Fixed single filteredCompanies variable (handles both search + White Labeling)
  const filteredCompanies =
    filterStatus === "White Labeling"
      ? []
                ...
                <h3 className="notification">Notifications</h3>
                 <div className="notify-row">
                   <div style={{ flex: 1, marginRight: 12 }}>
                     <label>Notification for emails</label>
                     <input
                       type="text"
                       className="notification-input"
                       value={editForm.notifyEmailText}
                       readOnly
                     />
                   </div>
                   <label className="switch">
                 ...
                 <div className="notify-row" style={{ marginTop: 5 }}>
                   <div style={{ flex: 1, marginRight: 12 }}>
                     <label>Notification for calls</label>
                     <input
                      type="text"
                      className="notification-input"
                      value={editForm.notifyCallText}
                      onChange={handleEditFieldChange}
                    />
                  </div>
                  <label className="switch">
                   <input
                      type="checkbox"
                      checked={editForm.notifyCall}
                      onChange={(e) =>
                        setEditForm({
                          ...editForm,
                          notifyCall: e.target.checked,
                        })
                      }
                    />
                     <span className="slider" />
