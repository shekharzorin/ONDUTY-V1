...
import superAdminAuthRoutes from "./src/superadminroutes/superadminauth.js";
import demoRoutes from "./src/routes/Bookdemo.js";
import superAdminmapSettingsRoutes from "./src/superadminroutes/mapSettingsRoutes.js";
...
// ✅ Allowed frontend URLs (from .env – separated)
...
app.use("/superadminmapsettings", superAdminmapSettingsRoutes);
...
app.get("/", (req, res) => {
  res.send(`🚀 Server is running on port ${PORT} ~ ✅ Version - 1.0.1.1`);
});
