  ...
  return (
    <div className="flex flex-col gap-5 items-center justify-center p-10 text-center h-screen font-semibold">
      <div className=" relative">
        <div className="text-3xl font-bold animate-bounce text-(--color-primary) -rotate-6 mb-5">
          Oops !
        </div>
        <Image src={arrowbend} width={100} alt="Arrow Bend" className="absolute -bottom-5 left-1/2 transform -translate-x-1/2" />
      </div>
