...
const Page = () => {
  ...
  return (
    <div className="flex flex-col gap-5 items-center justify-center p-10 text-center h-screen font-semibold">
      <div className=" relative  animate-bounce -rotate-6 mb-5 gap-5 flex items-center justify-center">
        <div className="text-3xl font-bold text-(--color-primary)">
          Oops !
        </div>
        <Image src={arrowbend} width={50} alt="Arrow Bend" className="absolute -bottom-5 left-1/2 transform -translate-x-1/2" />
      </div>
